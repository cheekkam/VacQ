...
const {getHospitals, getHospital, createHospital, updateHospital, deleteHospital, getVacCenters} = require('../controller/hospitals');
 ...
 * /hospitals/{id}:
 *  get:
 *      summary: Get the hospitals by id
 *      tags: [Hospitals]
 *      parameters:
 *          -   in: path
 *              name: id
